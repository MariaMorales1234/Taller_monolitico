...
if (!$canEdit) {
    ...
    echo '<div class="alert alert-warning">No se puede editar este programa porque tiene estudiantes o materias relacionadas.</div>';
...
<div class="container mt-4">
    ...
    <form action="update.php" method="POST" class="needs-validation" novalidate>
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" id="nombre" name="nombre" value="<?= htmlspecialchars($programa['nombre']) ?>" required maxlength="100">
